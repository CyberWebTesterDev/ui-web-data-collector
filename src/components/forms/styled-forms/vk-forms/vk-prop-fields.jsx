...
export const VkPropFieldHeadLabel = (props) => {
...
export const VkPropFieldStandard = ({ propertyName, value }) => {
  return (
    <React.Fragment>
      <div className="property-child-block">
...
export const VkPropFieldPhotoLinks = ({ propertyName, link }) => {
  return (
    <React.Fragment>
      <div className="property-child-block">
        <div className="label-div">{propertyName}</div>
