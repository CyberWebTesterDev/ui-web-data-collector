...
import { TableAssembler } from './tables/table-simple';
import { popupShow } from './popups/popup-actions';
import { POPUP_CONTAINER_CENTER_ERROR } from '../helpers/main-constants';
import {
   getMatchesSelector,
      ...
      return (
         <div>
            ...
            <RenderForm
               ...
               isPickedAgeToValid={
                  searchForm.fieldsValidation.isPickedAgeToValid
               }
            ...
            <TableAssembler data={vkMatches.matchedProfiles} />
         </div>
      );
   }
}
