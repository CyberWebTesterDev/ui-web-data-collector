...
import { makeCSSRuleByPropName } from '../utils/css-class-util';
      ...
      return (
         <React.Fragment>
            ...
            <TestRenderData
               ...
               makeTestCSSName={makeCSSRuleByPropName}
...
const TestRenderData = (props) => {
   const { obj, onClickListener, generateId, setPopup, setModal, makeTestCSSName } = props;
   ...
   return (
      <div className="test-block">
         ...
         <button id="getTestCSSName" onClick={() => makeTestCSSName('test', 'test2')}>
            Получить тестовое имя CSS
         </button>
         <button
            id="getTestPopup"
